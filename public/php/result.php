...
<body>
    ...
    <?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST["selectedTopic"]) && isset ($_POST["selectedSubtopic"])) {
        $selectedTopic = $_POST["selectedTopic"];
        $selectedSubtopic = $_POST["selectedSubtopic"];
        ...
        // Display questions and individual results
        ...
        echo "<p id='smallTitle'>Selected Topic: $selectedTopic</p>";
        echo "<p id='smallTitle'>Selected Subtopic: $selectedSubtopic</p>";

        // Display individual question results
        foreach ($questionResults as $index => $result) {
            echo "<p id='tittleQuestion'>Question " . ($index + 1) . ": " . $result["question"] . "</p>";
            echo "<p id='titleAnswer' class='ttle'><span class='orgttle'>Your Answer:</span> " . $result["userAnswer"] . "</p>";
            echo "<p class='ttle'><span class='orgttle'>Correct Answer:</span> " . $result["correctAnswer"] . "</p>";
            echo "<p class='ttle'><span class='orgttle'>Result:</span> " . $result["result"] . "</p>";
            echo "<hr>";
        }
